...
<div className="modal-toggle"></div>
    <header className="sticky-top">
        <nav className="navbar">
            <a href="./index.html" className="navbar-logo"><img src=".../assets/img/Image-logo.png" alt="landing-page logo" /></a>
            {/* <button className="hamburger-menu"><a href="./index.html" className="hamburger"></a></button> */}
            <ul className="navbar-menu">
                <li className="navbar-link"><a href="./login.html">Login</a></li>
                <li className="navbar-link"><a href="./signup.html">Sign Up</a></li>
